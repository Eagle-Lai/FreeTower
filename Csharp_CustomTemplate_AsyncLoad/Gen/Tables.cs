...
public sealed class Tables
{
    ...
    public async Task LoadAsync(System.Func<string, Task<JsonElement>> loader)
    {
        ...
        TbTestMultiColumn = new test.TbTestMultiColumn(await loader("test_tbtestmulticolumn")); 
        ...
        TbTestBeRef2 = new test.TbTestBeRef2(await loader("test_tbtestberef2")); 
        ...
        TbItem2 = new test.TbItem2(await loader("test_tbitem2")); 
        ...
        TbTestSep = new test.TbTestSep(await loader("test_tbtestsep")); 
        tables.Add("test.TbTestSep", TbTestSep);
        TbTestScriptableObject = new test.TbTestScriptableObject(await loader("test_tbtestscriptableobject")); 
